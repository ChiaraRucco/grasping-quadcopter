...
class quad_helper(object):
    ...
    '''
    Initialize sensors and reset quadcopter position
    '''
    ...
    '''
    Get quadcopter body frame orientation
    '''

    def get_orientation(self):
        err, self.quadHandle = vrep.simxGetObjectHandle(self.clientID, 'Body_frame', vrep.simx_opmode_oneshot)
    ...
    '''
    Get quadcopter body frame position
    '''
    ...
    '''
    Update angular rate PID controller
    '''
    ...
    '''
    Update the attitude PID controller
    '''
    ...
    '''
    Update the position PID controller
    '''
    ...
    '''
    Set the quadcopter angular acceleration
    '''
    ...
    '''
    Set the quadcopter position setpoint
    '''
    ...
    def get_obj_orien(self):
        ...
        obj_orien_rot = trasformations.quaternion_matrix([obj_orien[0], obj_orien[1], obj_orien[2],obj_orien[3]])
